...
public class RegisterC extends AppCompatActivity {
    ...
    EditText editTextNameCenter, editTextAddress, editTextEmail, editTextPassword, editTextFIO, editTextWorkTime, editTextPhone_number;
    Button buttonReg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonReg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String center_name, address, email, password, fio, work_time, phone_number;
