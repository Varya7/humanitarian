...
import com.example.hum1.databinding.ActivityAppFalseBinding;
...
public class AppFalse extends AppCompatActivity {
    ...
    private ActivityAppFalseBinding binding;
                ...
                if (!task.isSuccessful()) {
                    ...
                    if (snapshot.exists()) {
                        for (DataSnapshot applicationSnapshot : snapshot.getChildren()) {
                            ...
                            if (center.equals(center_name) && status.equals("Отклонено")) {
